...
import { showAddCommentState, showUpdateLaptop } from "../../atoms";
import React from "react";

export default function UpdateLaptop() {
  const [show, setShow] = useRecoilState(showUpdateLaptop);
  ...
  return (
    <ModalLayout className="pt-5" open={show} onClose={() => setShow(false)}>
      <Box className="flex justify-between items-center">
        <p className="font-bold text-xl p-5">Update Laptop</p>
